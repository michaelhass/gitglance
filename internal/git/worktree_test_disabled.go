...
// 		status[renamedPath] = &git.FileStatus{Staging: git.Renamed, Worktree: git.Unmodified}
// 		return status, nil
// 	})
...
// 	if status.Staged.Contains(renamedPath, Renamed) ||
// 		!status.Unstaged.Contains(renamedPath, Renamed) {
// 		t.Errorf("Only staged should include renamed file")
// 	}
// }
